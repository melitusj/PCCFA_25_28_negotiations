...
X2023_data_salary_long_plot[,1:3] %>% kbl(caption = "Table 2: Area CCC District Representive Salaries During the 2023-204 Academic Year Before and After Adjustment for Local Cost of Living", centering = TRUE,col.names = c("District", "Aggregate Salary", "Adjusted Aggregate Salary"), position = "left") %>%
